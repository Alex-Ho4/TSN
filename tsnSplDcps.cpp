...
/* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
    ...
    to->number_of_highest_message = (c_ulonglong)from->number_of_highest_message;
    return result;
}
...
/* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
        ...
        c_long length0;
        _TSN_serial_number *dest0;
        ::TSN::node_request::_requested_messages_seq *src = &from->requested_messages;
        ...
        to->requested_messages = (c_sequence)dest0;
#else
        dest0 = (_TSN_serial_number *)c_newSequence(c_collectionType(type0),length0);
        {
        /* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 1873 */
    ...
    struct _TSN_response *to)
{
    ...
    {
        typedef c_char _DestType[37];
        _DestType *dest = &to->parent_uuid;
        memcpy (dest, from->parent_uuid, sizeof (*dest));
    }
    to->parent_post_id = (c_ulong)from->parent_post_id;
    {
/* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
        ...
        c_long length0;
        c_string *dest0;
        ::TSN::response::_children_uuids_seq *src = &from->children_uuids;
        ...
        /* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 1928 */
            ...
            for (i0 = 0; (i0 < (unsigned int)length0) && result; i0++) {
                ...
                if((*src)[i0]){
                    ...
                    OS_REPORT (OS_ERROR, "copyIn", 0,"Element of 'TSN::response.*src' of type 'c_string' is NULL.");
                    result = OS_C_FALSE;
                }
#else
                dest0[i0] = c_stringNew(base, (*src)[i0]);
        ...
        to->children_uuids = (c_sequence)dest0;
#else
        dest0 = (c_string *)c_newSequence(c_collectionType(type0),length0);
        {
        /* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 1928 */
...
/* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 774 */
        ...
        c_long length0;
        _TSN_serial_number *dest0;
        ::TSN::response::_children_post_ids_seq *src = &from->children_post_ids;
        ...
        to->children_post_ids = (c_sequence)dest0;
#else
        dest0 = (_TSN_serial_number *)c_newSequence(c_collectionType(type0),length0);
        {
        /* Code generated by /home/dds/OvernightTests/tmp.EvVa0SFLQ3/build/src/tools/idlpp/code/idl_genCorbaCxxCopyin.c at line 1873 */
    ...
    void *_to)
{
    ...
    to->number_of_highest_message = (::DDS::ULongLong)from->number_of_highest_message;
}
    ...
    void *_to)
{
    ...
    {
        long size0;
        _TSN_serial_number *src0 = (_TSN_serial_number *)from->requested_messages;
        ::TSN::node_request::_requested_messages_seq *dst = &to->requested_messages;

        size0 = c_arraySize(c_sequence(from->requested_messages));
        to->requested_messages.length(size0);
        {
            _TSN_serial_number *buf0;
            buf0 = (_TSN_serial_number *)(*dst).get_buffer();
            memcpy (buf0,src0,size0* sizeof(*buf0));
    ...
    void *_to)
{
    ...
    {
        typedef c_char _DestType[37];
        _DestType *src = &from->parent_uuid;

        memcpy (to->parent_uuid, src, sizeof (*src));
    }
    to->parent_post_id = (::DDS::ULong)from->parent_post_id;
    {
        long size0;
        c_string *src0 = (c_string *)from->children_uuids;
        ::TSN::response::_children_uuids_seq *dst = &to->children_uuids;

        size0 = c_arraySize(c_sequence(from->children_uuids));
        to->children_uuids.length(size0);
        {
            long i0;
            for (i0 = 0; i0 < size0; i0++) {
                (*dst)[i0] = DDS::string_dup(src0[i0]);
    ...
    {
        long size0;
        _TSN_serial_number *src0 = (_TSN_serial_number *)from->children_post_ids;
        ::TSN::response::_children_post_ids_seq *dst = &to->children_post_ids;

        size0 = c_arraySize(c_sequence(from->children_post_ids));
        to->children_post_ids.length(size0);
        {
            _TSN_serial_number *buf0;
            buf0 = (_TSN_serial_number *)(*dst).get_buffer();
            memcpy (buf0,src0,size0* sizeof(*buf0));
