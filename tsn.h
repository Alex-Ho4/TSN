...
//  File name: tsn.h
//  Source: idl/tsn.idl
//  Generated: Fri Nov  2 02:40:20 2018
...
namespace TSN
{
   ...
   struct user_information
   {
         ...
         DDS::ULongLong number_of_highest_message;
   };
   ...
   struct node_request
   {
         ...
         struct _requested_messages_seq_uniq_ {};
         typedef DDS_DCPSUFLSeq < DDS::ULong, struct _requested_messages_seq_uniq_> _requested_messages_seq;
         typedef DDS_DCPSSequence_var < _requested_messages_seq> _requested_messages_seq_var;
         typedef DDS_DCPSSequence_out < _requested_messages_seq> _requested_messages_seq_out;
         _fulfiller_uuid fulfiller_uuid;
         _requested_posts_seq requested_posts;
         _requested_messages_seq requested_messages;
   };
   ...
   struct response
   {
         ...
         typedef DDS_DCPS_FArray_var< _uuid, _uuid_slice, struct _uuid_uniq_> _uuid_var;
         typedef DDS_DCPS_Array_forany< _uuid, _uuid_slice, struct _uuid_uniq_> _uuid_forany;
         typedef DDS::Char _parent_uuid_slice;
         typedef DDS::Char _parent_uuid[37];
         typedef _parent_uuid _parent_uuid_out;
         static _parent_uuid_slice * _parent_uuid_alloc ();
         static void _parent_uuid_free (_parent_uuid_slice *);
         static void _parent_uuid_copy (_parent_uuid_slice* to, const _parent_uuid_slice* from);
         static _parent_uuid_slice *_parent_uuid_dup (const _parent_uuid_slice* from);

         struct _parent_uuid_uniq_ {};
         typedef DDS_DCPS_FArray_var< _parent_uuid, _parent_uuid_slice, struct _parent_uuid_uniq_> _parent_uuid_var;
         typedef DDS_DCPS_Array_forany< _parent_uuid, _parent_uuid_slice, struct _parent_uuid_uniq_> _parent_uuid_forany;
         struct _children_uuids_seq_uniq_ {};
         typedef DDS_DCPSUStrSeqT <struct _children_uuids_seq_uniq_> _children_uuids_seq;
         typedef DDS_DCPSUStrSeq_var < _children_uuids_seq> _children_uuids_seq_var;
         typedef DDS_DCPSUStrSeq_out < _children_uuids_seq> _children_uuids_seq_out;
         struct _children_post_ids_seq_uniq_ {};
         typedef DDS_DCPSUFLSeq < DDS::ULong, struct _children_post_ids_seq_uniq_> _children_post_ids_seq;
         typedef DDS_DCPSSequence_var < _children_post_ids_seq> _children_post_ids_seq_var;
         typedef DDS_DCPSSequence_out < _children_post_ids_seq> _children_post_ids_seq_out;
         _uuid uuid;
         DDS::ULong post_id;
         DDS::String_mgr post_body;
         DDS::Long date_of_creation;
         _parent_uuid parent_uuid;
         DDS::ULong parent_post_id;
         _children_uuids_seq children_uuids;
         _children_post_ids_seq children_post_ids;
   };
...
template <>
TSN::response::_parent_uuid_slice* DDS_DCPS_ArrayHelper < TSN::response::_parent_uuid, TSN::response::_parent_uuid_slice, TSN::response::_parent_uuid_uniq_>::alloc ();
template <>
void DDS_DCPS_ArrayHelper < TSN::response::_parent_uuid, TSN::response::_parent_uuid_slice, TSN::response::_parent_uuid_uniq_>::copy (TSN::response::_parent_uuid_slice *to, const TSN::response::_parent_uuid_slice* from);
template <>
void DDS_DCPS_ArrayHelper < TSN::response::_parent_uuid, TSN::response::_parent_uuid_slice, TSN::response::_parent_uuid_uniq_>::free (TSN::response::_parent_uuid_slice *ptr);
template <>
