...
// DDS TSN::private_message TypeSupportFactory Object Body

::DDS::DataWriter_ptr
TSN::private_messageTypeSupportFactory::create_datawriter (gapi_dataWriter handle)
{
    return new TSN::private_messageDataWriter_impl(handle);
}

::DDS::DataReader_ptr
TSN::private_messageTypeSupportFactory::create_datareader (gapi_dataReader handle)
{
    return new TSN::private_messageDataReader_impl (handle);
}


::DDS::DataReaderView_ptr
TSN::private_messageTypeSupportFactory::create_view (gapi_dataReaderView handle)
{
    return new TSN::private_messageDataReaderView_impl (handle);
}

// DDS TSN::private_message TypeSupport Object Body

TSN::private_messageTypeSupport::private_messageTypeSupport(void) :
    TypeSupport_impl(
        __TSN_private_message__name(),
        __TSN_private_message__keys(),
        TSN::private_messageTypeSupport::metaDescriptor,
        (gapi_copyIn) __TSN_private_message__copyIn,
        (gapi_copyOut) __TSN_private_message__copyOut,
        (gapi_readerCopy) ::DDS::ccpp_DataReaderCopy<TSN::private_messageSeq, TSN::private_message>,
        new  TSN::private_messageTypeSupportFactory(),
        TSN::private_messageTypeSupport::metaDescriptorArrLength)
{
    // Parent constructor takes care of everything.
}
...
::DDS::ReturnCode_t
TSN::private_messageTypeSupport::register_type(
    ::DDS::DomainParticipant_ptr domain,
    const char * type_name) THROW_ORB_EXCEPTIONS
{
    return TypeSupport_impl::register_type(domain, type_name);
...
char *
TSN::private_messageTypeSupport::get_type_name() THROW_ORB_EXCEPTIONS
{
    return TypeSupport_impl::get_type_name();
}
...
TSN::private_messageDataWriter_impl::~private_messageDataWriter_impl(void)
{
    // Parent destructor takes care of everything.
}
...
TSN::private_messageDataReader_impl::private_messageDataReader_impl (
    gapi_dataReader handle
) : ::DDS::DataReader_impl(handle, ::DDS::ccpp_DataReaderParallelDemarshallingMain<TSN::private_messageSeq>)
{
    // Parent constructor takes care of everything.
}

TSN::private_messageDataReader_impl::~private_messageDataReader_impl(void)
{
    // Parent destructor takes care of everything.
}
...
TSN::private_messageDataReaderView_impl::~private_messageDataReaderView_impl(void)
{
    // Parent destructor takes care of everything.
}
...
"<Sequence><String/></Sequence></Member><Member name=\"number_of_highest_post\"><ULongLong/></Member><Member name=\"number_of_highest_message\">",
"<ULongLong/></Member></Struct></Module></MetaData>"};
...
"<Sequence><Type name=\"serial_number\"/></Sequence></Member><Member name=\"requested_messages\"><Sequence>",
"<Type name=\"serial_number\"/></Sequence></Member></Struct><Struct name=\"request\"><Member name=\"uuid\">",
"<String length=\"37\"/></Member><Member name=\"user_requests\"><Sequence><Type name=\"node_request\"/>",
"</Sequence></Member></Struct></Module></MetaData>"};
const ::DDS::ULong (::TSN::requestTypeSupport::metaDescriptorArrLength) = 6;
...
"<Member name=\"parent_uuid\"><Array size=\"37\"><Char/></Array></Member><Member name=\"parent_post_id\">",
"<Type name=\"serial_number\"/></Member><Member name=\"children_uuids\"><Sequence><String/></Sequence>",
"</Member><Member name=\"children_post_ids\"><Sequence><Type name=\"serial_number\"/></Sequence></Member>",
"</Struct></Module></MetaData>"};
const ::DDS::ULong (::TSN::responseTypeSupport::metaDescriptorArrLength) = 7;
const char * ::TSN::private_messageTypeSupport::metaDescriptor[] = {"<MetaData version=\"1.0.0\"><Module name=\"TSN\"><Struct name=\"private_message\"><Member name=\"receiver_uuid\">",
...
"</Module></MetaData>"};
const ::DDS::ULong (::TSN::private_messageTypeSupport::metaDescriptorArrLength) = 4;
