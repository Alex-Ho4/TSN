...
struct _TSN_user_information {
    ...
    c_ulonglong number_of_highest_message;
};
...
struct _TSN_response {
    ...
    c_char parent_uuid[37];
    _TSN_serial_number parent_post_id;
    c_sequence children_uuids;
    c_sequence children_post_ids;
};
