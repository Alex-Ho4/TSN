...
#if DDS_USE_EXPLICIT_TEMPLATES
template class DDS_DCPSUFLSeq < TSN::serial_number, struct _children_post_ids_seq_uniq_>;
#endif
#if DDS_USE_EXPLICIT_TEMPLATES
template class DDS_DCPSUVLSeq < DDS::String, struct _children_uuids_seq_uniq_>;
#endif

#if DDS_USE_EXPLICIT_TEMPLATES
template class DDS_DCPS_FArray_var< TSN::response::_parent_uuid, TSN::response::_parent_uuid_slice, struct TSN::response::_parent_uuid_uniq_>;
template class DDS_DCPS_Array_forany< TSN::response::_parent_uuid, TSN::response::_parent_uuid_slice, struct TSN::response::_parent_uuid_uniq_>;
#endif
...
{
   return TSN::response::_parent_uuid_alloc ();
}
...
{
   TSN::response::_parent_uuid_copy (to, from);
}
...
{
   TSN::response::_parent_uuid_free (ptr);
}

TSN::response::_parent_uuid_slice * TSN::response::_parent_uuid_alloc ()
{
   DDS::Char * ret = (DDS::Char*) new DDS::Char [37];
   return (_parent_uuid_slice *) ret;
}

void TSN::response::_parent_uuid_free (_parent_uuid_slice * s)
{
   delete [] s;
}

void TSN::response::_parent_uuid_copy
(
   _parent_uuid_slice * to,
   const _parent_uuid_slice * from
)
{
   const DDS::Char* sv = ( const DDS::Char*) from;
   DDS::Char* tv = (DDS::Char*) to;
...
TSN::response::_parent_uuid_slice * TSN::response::_parent_uuid_dup
   (const _parent_uuid_slice * from)
{
   _parent_uuid_slice * to = _parent_uuid_alloc ();
   _parent_uuid_copy (to, from);
   return to;
}
...
#if DDS_USE_EXPLICIT_TEMPLATES
template class DDS_DCPSUFLSeq < TSN::serial_number, struct _requested_messages_seq_uniq_>;
#endif
#if DDS_USE_EXPLICIT_TEMPLATES
